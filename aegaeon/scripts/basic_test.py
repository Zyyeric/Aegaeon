...
def _patch_model_path(local_model_dir: str) -> None:
    default_model_path = ModelType.qwen2_1_5b.path()
    if local_model_dir == default_model_path:
        return

    original_path = ModelType.path

    def patched_path(self):
        if self == ModelType.qwen2_1_5b:
            return local_model_dir
        return original_path(self)

    ModelType.path = patched_path
