...
class TensorsMeta:
    ...
    def from_tensors_file(cls, st_file_path: str):
        ...
        json_data["file_path"] = st_file_path
...
class TensorsContent:
    ...
    def __init__(
        ...
        self._storage: torch.UntypedStorage = _storage
        self.is_global_storage = is_global_storage
    ...
    def to_tensors(self) -> Generator[Tuple[str, torch.Tensor], None, None]:
        ...
        # logger.info(f'to_tensors: {tensor_info_map}')
        ...
        if checkpoint_config is None:
            ...
            for i in range(checkpoint_config.parallel_size):
                sharding_meta = ShardingMeta.from_model_path(
                    model_path, i, checkpoint_config
                )
